    ...
    while (true){
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (line.startsWith("RESERVE") && line.length() > 7 && line.charAt(7) == ' ') {
                    ...
                    // Temporary reservation key to represent the reservation slot (in Phase 2, this will be replaced with database or array checks)
                    String slotKey = sport + "-" + day + "-" + time;

                    // For testing purposes, all reservations are automatically confirmed
